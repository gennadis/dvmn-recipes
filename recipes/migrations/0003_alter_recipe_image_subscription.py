            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1, verbose_name="Servings amount"
                    ),
                ),
                (
                    "daily_meals_amount",
                    models.PositiveSmallIntegerField(
                        default=3, verbose_name="Daily meals amount"
                    ),
                ),
                (
                    "allergies",
                ...
                (
                    "is_paid",
                    models.BooleanField(
                        default=False, verbose_name="Subscription payment status"
                    ),
                ),
                (
                    "meal_type",
